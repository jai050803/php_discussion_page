  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/jai/28_form_sql.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result) {
        ...
        <strong>SUCCESS!</strong> your feedback is sent successfully. "
...
<div class="container" style="padding-top: 30px;">
    <h1>Contact Us with your concerns</h1>
<form action="/jai/28_form_sql.php" method="post">
